...
class IA:
    ...
    def heuristique(self, jeu: Echec, couleur):
        ...
        # nombre de nos pièces (on veut s'en débarrasser) - nombre de leurs pièces (on veut qu'ils en perdent)
        ...
        # on veut pouvoir bouger pour se faire capturer => bonus si beaucoup de coups possibles
